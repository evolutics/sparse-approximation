...
selected_algorithms = {
    ...
    "gRMP, exponential",
    "gRMP, linear",
    "Multi Warm-JS SP, J-varied",
    "Multi Warm-JS SP, η-varied",
    "Multi Warm-KL SP",
    "OMP",
    "SP, lᵢ=k, i∈[k]",
    "SP, lᵢ=k/2ⁱ",
    ...
    "Warm-JS, ηᵢ=D, j=4k",
    "Warm-KL CoSaMP, ηᵢ=1/(2i+1), j=4k, lᵢ=2k, i∈[⌊log₂ k⌋+1]",
    "Warm-KL CoSaMP, ηᵢ=1/(2i+1), j=4k, lᵢ=2k, i∈[k]",
    "Warm-KL CoSaMP, ηᵢ=1/(2i+1), j=4k, lᵢ=2k/2ⁱ",
    "Warm-KL CoSaMP, ηᵢ=D, j=4k, lᵢ=2k, i∈[⌊log₂ k⌋+1]",
    "Warm-KL CoSaMP, ηᵢ=D, j=4k, lᵢ=2k, i∈[k]",
    "Warm-KL CoSaMP, ηᵢ=D, j=4k, lᵢ=2k/2ⁱ",
...
algorithms = {
    ...
    "Multi Warm-JS SP, J-varied": lambda C, p, D, k: multi_warm_subspace_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Multi Warm-JS SP, η-varied": lambda C, p, D, k: multi_warm_subspace_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Warm-KL CoSaMP, ηᵢ=1/(2i+1), j=4k, lᵢ=2k, i∈[⌊log₂ k⌋+1]": lambda C, p, D, k: warm_compressive_sampling_matching_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Warm-KL CoSaMP, ηᵢ=1/(2i+1), j=4k, lᵢ=2k, i∈[k]": lambda C, p, D, k: warm_compressive_sampling_matching_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Warm-KL CoSaMP, ηᵢ=1/(2i+1), j=4k, lᵢ=2k/2ⁱ": lambda C, p, D, k: warm_compressive_sampling_matching_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Warm-KL CoSaMP, ηᵢ=D, j=4k, lᵢ=2k, i∈[⌊log₂ k⌋+1]": lambda C, p, D, k: warm_compressive_sampling_matching_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Warm-KL CoSaMP, ηᵢ=D, j=4k, lᵢ=2k, i∈[k]": lambda C, p, D, k: warm_compressive_sampling_matching_pursuit.solve(
        C,
        p,
        D,
        k,
    ...
    "Warm-KL CoSaMP, ηᵢ=D, j=4k, lᵢ=2k/2ⁱ": lambda C, p, D, k: warm_compressive_sampling_matching_pursuit.solve(
        C,
        p,
        D,
        k,
